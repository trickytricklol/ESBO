...
def parse_args():
    ...
    parser.add_argument('--model', default='pointNetSort', help='model name [default: pointnet_cls]')
    ...
    parser.add_argument('--last', type=str, default='', help='number of epoch in training')
...
def main():
    ...
    if not os.path.isfile(os.path.join(args.checkpoint, "last_checkpoint.pth")):
        ...
        if args.last:
            checkpoint_path = os.path.join(args.last, "best_checkpoint.pth")
