...
or
CUDA_VISIBLE_DEVICES=0 nohup python main.py --model pointSMLP_Density_sphere_FPS_sphere --msg demo > pointSMLP_Density_sphere_FPS_sphere.out &
"""
import argparse
import os
import logging
...
def parse_args():
    ...
    parser.add_argument('--model', default='DGCNN', help='model name [default: DGCNN]')
    parser.add_argument('--ver', default='hard', help='dataset ver [default: easy/hard] ')
    ...
    """SinPoint"""
    parser.add_argument('--rand_center_num', type=int, default=4, help='k=0: Global and k>0: Local')
...
def main():
    ...
    train_loader = DataLoader(ScanObjectNN(partition='train', num_points=args.num_points, ver=args.ver), num_workers=args.workers,
                                batch_size=args.batch_size, shuffle=True, drop_last=True)
    test_loader = DataLoader(ScanObjectNN(partition='test', num_points=args.num_points, ver=args.ver), num_workers=args.workers,
