...
from train import train_vanilla, train_AugTune, test, train_advf
from testmodelnetc import test_modelnet_c
from test import test_bottleneck
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='dgcnn', metavar='N',
                        choices=['pointnet', 'dgcnn', 'pointnet2'],
    ...
    parser.add_argument('--classes', type=int, default=40, metavar='N',
                        help='number of prediction classes')
    
    parser.add_argument('--test_modelnet_c', action='store_true', help='Use modelnetc')
    parser.add_argument('--modelnet_c_path', type=str,
                         default='/mnt/c/Users/Administrator/readmodelnet/modelnet40_c',metavar='N')
    ...
    parser.add_argument('--ka', action='store_true', help='Use ka')
    
    parser.add_argument('--s', type=float, default=15, help='the sharpness of the transition')  
    parser.add_argument('--u', type=float, default=0.8, help='ritical boundary') 

    parser.add_argument('--sigma', type=float, default=1.5, help='cale parameter')

    parser.add_argument('--advf', action='store_true', help='Use advf')
    ...
    if not args.eval:
        ...
        if args.test_modelnet_c:
            test_modelnet_c(args,io)
        else:
            test(args, io)
